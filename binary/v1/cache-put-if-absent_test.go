...
func Test_client_CachePutIfAbsent(t *testing.T) {
	...
	// put test values
	if err = c.CachePut("TestCache1", false, "key2", "value 2", &status); err != nil {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := tt.c.CachePutIfAbsent(tt.args.cache, tt.args.binary, tt.args.key, tt.args.value, tt.args.status)
